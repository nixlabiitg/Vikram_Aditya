...
<div class="main-content p-6 min-h-screen">
    ...
    <div class="overflow-x-auto rounded-lg">
        ...
        <table class="min-w-[700px] md:min-w-full sm:min-w-full text-center">
            <thead class="bg-[#FFF4E6] text-[#7A3E00] border-b border-orange-400">
                <tr>
                    <th class="px-6 py-3 text-sm font-semibold">Complaint ID</th>
                    <th class="px-6 py-3 text-sm font-semibold">Date</th>
                    <th class="px-6 py-3 text-sm font-semibold">Client</th>
                    <th class="px-6 py-3 text-sm font-semibold">Astrologer</th>
            ...
            <tbody class="bg-[#FFF4E6] text-gray-700">
                <?php
                $complaints = [
                ...
                foreach ($complaints as $row) {
                    ...
                    foreach ($row as $i => $value) {
                        echo '<td class="px-6 py-4 border-b border-orange-400">' . $value . '</td>';
                    }
                    echo '<td class="px-6 py-4 border-b border-orange-400 text-center">';
