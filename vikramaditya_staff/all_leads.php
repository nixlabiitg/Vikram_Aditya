...
<div class="main-content p-4 sm:p-6">
    ...
    <div class="bg-[#FFF9F0] shadow rounded-lg p-4 mb-6 border border-[#FFD699] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <input type="text" placeholder="Search Leads." class="border border-gray-300 rounded px-4 py-2 w-full sm:w-64" />
    ...
    <div id="lead-detail" class="hidden mt-4 bg-white p-6 rounded-xl shadow-md border border-gray-200">
        ...
        <div class="mt-3">
            <button onclick="window.location.href='lead_edit'" class="px-2 py-1 bg-yellow-500 text-white rounded"><svg xmlns="http://www.w3.org/2000/svg" 
                fill="none" 
                viewBox="0 0 24 24" 
                stroke="currentColor" 
                stroke-width="2" 
