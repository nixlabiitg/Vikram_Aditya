    ...
    <form action="#" method="POST" enctype="multipart/form-data" class="max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-md" onsubmit="return saveComplain(event);">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="name" class="w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" required />
            </div>
            <div>
                <label class="block font-semibold text-sm text-gray-700 mb-1">Contact Info</label>
                <input type="text" name="contact" class="w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" required />
            </div>

            <div>
                <label class="block font-semibold text-sm text-gray-700 mb-1">Booking Reference ID</label>
                <input type="text" name="booking_id" class="w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" />
            </div>
            <div>
                <label class="block font-semibold text-sm text-gray-700 mb-1">Astrologer Name</label>
                <select name="astrologer" class="w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400">
            ...
            <div>
                ...
                <select name="type" class="w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400">
                    <option>Minor</option>
                    <option>Major</option>
            ...
            <div>
                ...
                <select name="category" class="w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400">
                    <option>Delay</option>
        ...
        <div class="mt-6">
            ...
            <textarea name="description" rows="4" maxlength="800" class="w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" required></textarea>
        </div>
