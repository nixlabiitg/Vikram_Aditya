...
<div class="main-content p-4 md:p-6">
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 md:mb-6 space-y-2 md:space-y-0">
        <h1 class="text-2xl font-bold text-[#7A3E00]">All Appointments</h1>
        <a href="appointment_book">
            <button class="px-4 py-2 bg-[#FF7F50] text-white rounded hover:bg-[#E67300] w-full md:w-auto">Book</button>
        </a>
    </div>
    ...
    <div class="bg-[#FFF9F0] shadow rounded-lg p-4 border border-[#FFD699] overflow-x-auto">
        <h2 class="text-lg font-semibold text-[#7A3E00] mb-4">Appointment List</h2>
        <div class="overflow-x-auto -webkit-overflow-scrolling-touch">
            <table class="min-w-[700px] md:min-w-full sm:min-w-full">
                <thead>
                    <tr class="bg-[#FFEBD6] text-center">
                        ...
                        <th class="p-2 border-b border-[#FFD699]">Branch</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="hover:bg-[#FFF4E0] text-center">
                        ...
                        <td class="p-2 border-b border-[#FFD699]">ASTRO001</td>
                        <td class="p-2 border-b border-[#FFD699]"><a href="client_view">Rajesh Kumar</a></td>
                        <td class="p-2 border-b border-[#FFD699]">Self</td>
                        ...
                        <td class="p-2 border-b border-[#FFD699]">Pathsala</td>
                    </tr>
                    <tr class="hidden bg-[#FFF9F0] extra-row">
                        <td colspan="7" class="p-4 border-b border-[#FFD699]">
                            <div class="grid md:grid-cols-2 gap-4">
                                <div>
                                    <p><strong>Suggestions:</strong> <button onclick="window.location.href='suggestion_all'" class="px-3 py-1 bg-blue-500 text-white rounded" onclick=""><svg xmlns="http://www.w3.org/2000/svg" 
                                        fill="none" 
                                        viewBox="0 0 24 24" 
                                        stroke="currentColor" 
                                        stroke-width="2" 
                                    ...
                                    <path stroke-linecap="round" stroke-linejoin="round" 
                                            d="M12 20V4M12 20c-2-2-5-2-8-2V4c3 0 6 0 8 2m0 14c2-2 5-2 8-2V4c-3 0-6 0-8 2"/>
                                    </svg>
                                    </button></p>
                                ...
                                <div>
                                    <div class="flex gap-2 mb-2">
                                        <button onclick="openConfirm()" class="px-3 py-1 bg-yellow-500 text-white rounded"><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <p><strong>Payments:</strong> <button id="paymentBtn" class="px-3 py-1 bg-green-600 text-white rounded">
                    ...
                    <tr class="hover:bg-[#FFF4E0] text-center">
                        ...
                        <td class="p-2 border-b border-[#FFD699]">ASTRO002</td>
                        <td class="p-2 border-b border-[#FFD699]"><a href="client_view">Priya Dahal</a></td>
                    ...
                    <tr class="hover:bg-[#FFF4E0] text-center">
                        ...
                        <td class="p-2 border-b border-[#FFD699]">ASTRO002</td>
                        <td class="p-2 border-b border-[#FFD699]"><a href="client_view">Ankit Mehra</a></td>
                        <td class="p-2 border-b border-[#FFD699]">self</td>
                        <td class="p-2 border-b border-[#FFD699]">+919988776655</td>
                        <td class="p-2 border-b border-[#FFD699]">19-09-2025</td>
                        <td class="p-2 border-b border-[#FFD699]">10:30 am</td>
                        <td class="p-2 border-b border-[#FFD699]">Pathsala</td>
                    ...
                    <tr class="hidden bg-[#FFF9F0] extra-row">
                        <td colspan="7" class="p-4 border-b border-[#FFD699]">
                            <div class="grid md:grid-cols-2 gap-4">
                                <div>
                                    <p><strong>Suggestions: </strong><button onclick="window.location.href='suggestion_all'" class="px-3 py-1 bg-blue-500 text-white rounded"><svg xmlns="http://www.w3.org/2000/svg" 
                                        fill="none" 
                                        viewBox="0 0 24 24" 
                                        stroke="currentColor" 
                                        stroke-width="2" 
...
<div id="confirmPopup" class="hidden fixed inset-0 flex items-center justify-center bg-black/30 bg-opacity-50 z-50">
  <div class="bg-white rounded-lg p-6 w-80 shadow-lg">
    ...
    <div class="flex justify-end space-x-3">
      <button onclick="closeConfirm()" class="px-4 py-2 bg-gray-300 rounded"><svg xmlns="http://www.w3.org/2000/svg" 
     class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
  <path d="M6.225 4.811a1 1 0 011.414 0L12 9.172l4.361-4.361a1 1 0 111.414 1.414L13.414 10.5l4.361 4.361a1 1 0 01-1.414 1.414L12 11.914l-4.361 4.361a1 1 0 01-1.414-1.414L10.586 10.5 6.225 6.139a1 1 0 010-1.328z" />
</svg>
</button>
...
<div id="formPopup" class="hidden fixed inset-0 flex items-center justify-center bg-black/30 bg-opacity-50 z-50">
  <div class="bg-white rounded-lg p-6 w-96 shadow-lg">
    <h2 class="text-lg font-semibold text-gray-800 mb-4"><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg> Appointment</h2>
    <form class="space-y-4">
      ...
      <div class="flex justify-end space-x-3">
        <button type="button" onclick="closeForm()" class="px-4 py-2 bg-gray-300 rounded"><svg xmlns="http://www.w3.org/2000/svg" 
     class="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
  <path d="M6.225 4.811a1 1 0 011.414 0L12 9.172l4.361-4.361a1 1 0 111.414 1.414L13.414 10.5l4.361 4.361a1 1 0 01-1.414 1.414L12 11.914l-4.361 4.361a1 1 0 01-1.414-1.414L10.586 10.5 6.225 6.139a1 1 0 010-1.328z" />
</svg>
</button>
...
function filterAppointments() {
    ...
    const branchFilter = document.querySelectorAll('select')[1].value.toLowerCase();
    ...
    for (let i = 0; i < rows.length; i += 2) { 
        ...
        const name = cells[2].textContent.toLowerCase(); // Only search Name
        const date = cells[5].textContent;
        const branch = cells[7]?.textContent.toLowerCase() || ''; 

        const matchesSearch = name.includes(searchInput); // Only Name

        let matchesBranch = true;
        if (branchFilter && branchFilter !== "all") {
            matchesBranch = branch.includes(branchFilter);
        }
        ...
        if (statusFilter.toLowerCase() !== "all") {
            ...
            const appDateObj = new Date(`${appointmentDate[2]}-${appointmentDate[1]}-${appointmentDate[0]}`);
            if (statusFilter.toLowerCase() === "today") {
                matchesStatus = appDateObj.toDateString() === today.toDateString();
            } else if (statusFilter.toLowerCase() === "upcoming") {
                matchesStatus = appDateObj > today;
            }
        }
...
document.querySelector('input[type="text"]').addEventListener('input', filterAppointments);
document.querySelectorAll('select').forEach(sel => sel.addEventListener('change', filterAppointments));
