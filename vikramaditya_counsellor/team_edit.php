...
<div class="main-content p-6">
    <h1 class="text-2xl font-bold text-[#7A3E00] mb-6">Edit Team Member Details</h1>
        ...
        <form id="teamForm" class="space-y-6" onsubmit="return saveTeamMember(event)">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="fullName" class="w-full border border-gray-300 rounded px-4 py-2" placeholder="Enter Full Name">
                </div>
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-1">Phone Number</label>
                    <input type="text" id="phoneNumber" class="w-full border border-gray-300 rounded px-4 py-2" placeholder="Enter Phone Number">
                </div>
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-1">Email</label>
                    <input type="email" id="email" class="w-full border border-gray-300 rounded px-4 py-2" placeholder="Enter Email">
                </div>
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-1">Role</label>
                    <select id="roleSelect" class="w-full border border-gray-300 rounded px-4 py-2" onchange="handleRoleChange(this)">
                    ...
                    <div id="otherRoleInput" class="mt-2 hidden">
                        <input type="text" id="customRole" placeholder="Enter custom role" class="w-full border border-gray-300 rounded px-4 py-2">
                    </div>
            ...
            <div>
                ...
                <textarea id="notes" class="w-full border border-gray-300 rounded px-4 py-2" rows="4" placeholder="Any remarks or team member details..."></textarea>
            </div>
