...
<div class="main-content p-6">
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 md:mb-6 space-y-2 md:space-y-0">
        <h1 class="text-2xl font-bold text-[#7A3E00]">Edit Client Details</h1>
        <a href="client_reg">
            <button class="px-4 py-2 bg-[#FF7F50] text-white rounded hover:bg-[#E67300] w-full md:w-auto">View</button>
        </a>
    </div>
    ...
    <div class="bg-[#FFF9F0] shadow rounded-lg p-6 border border-[#FFD699]">
        <form id="clientForm" class="space-y-6" onsubmit="return saveClient(event);">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-2">Appointment for</label>
            ...
            <div>
                ...
                <textarea class="w-full border border-gray-300 rounded px-4 py-2" rows="4 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" placeholder="Any remarks or client details..."></textarea>
            </div>
...
<script>
    function saveClient(event) {
        ...
        window.location.href = "all_client.php";
