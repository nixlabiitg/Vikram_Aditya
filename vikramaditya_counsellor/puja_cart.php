  ...
  const cartData = [
    {
      ...
      items: [
        { name: "Ganesh Puja", price: 15000 },
        { name: "Narayan Puja", price: 12000 }
      ]
    },
    {
      client: { name: "Priya Desai", id: "C1044", phone: "+91 9123456780" },
      items: [
        { name: "Graha Puja", price: 8000 }
      ]
    },
    {
      client: { name: "Ankit Mehra", id: "C1099", phone: "+91 9988776655" },
      items: [
        { name: "Griha Shanti Puja", price: 1200 },
        { name: "Laxmi Puja", price: 800 }
      ]
    }
  ];
    ...
    cartData.forEach((order, index) => {
      ...
      expandRow.innerHTML = `
        <td colspan="7" class="p-4 text-center">
          <button onclick="window.location.href='puja_accepted'" 
                  class="px-6 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-green-700">
            book Now
          </button>
        </td>
      `;
