    ...
    <div class="bg-[#FFF9F0] shadow rounded-lg p-6 border border-[#FFD699]">
        <form id="clientForm" class="space-y-3 bg-[#FFF9F0] shadow rounded-lg p-6 border border-[#FFD699]" onsubmit="return saveClient(event);">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-2">Full Name</label>
                    <input type="text" class="animated-placeholder w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" data-placeholder="Enter Full Name...">
                </div>
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-2">Phone Number</label>
                    <input type="text" class="animated-placeholder w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" data-placeholder="Enter Phone Number...">
                </div>
                <div class="mt-4">
                    <label class="block text-[#7A3E00] font-semibold mb-2">Referred by</label>
                    <input type="text" class="animated-placeholder w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" data-placeholder="Referred by...">
                </div>
                <div class="mt-4">
                    <label class="block text-[#7A3E00] font-semibold mb-2">Service Interested</label>
                    <input type="text" class="animated-placeholder w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" data-placeholder="e.g., Speak with Vikramaditya...">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="mt-4">
                    <label class="block text-[#7A3E00] font-semibold mb-2">Appointment Date</label>
                ...
                <div class="mt-4">
                    ...
                    <input type="text" class="animated-placeholder w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" data-placeholder="Kushti...">
                </div> 
            </div>

            <div>
                <label class="block text-[#7A3E00] font-semibold mb-2">Additional Notes</label>
                <textarea class="animated-placeholder w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" rows="4" data-placeholder="Any remarks or client details..."></textarea>
            </div>
            <div>
...
<!-- <script>
  ...
  document.querySelectorAll(".animated-placeholder").forEach(input => {
    const text = input.getAttribute("data-placeholder");
    animatePlaceholder(input, text);
  });
</script> -->
<script>
  function animatePlaceholder(input, text) {
