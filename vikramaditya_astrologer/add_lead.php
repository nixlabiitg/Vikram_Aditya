...
<div class="p-6">
  ...
  <div x-data="leadTabs">
    ...
    <div class="flex space-x-4 border-b border-gray-200 mb-6">
      <button 
        @click="tab = 'manual'" 
        :class="tab === 'manual' ? 'border-b-2 border-yellow-600 text-yellow-700' : 'text-gray-500'" 
        class="pb-2 font-medium">
        Manual
      </button>
      <button 
        @click="tab = 'bulk'" 
        :class="tab === 'bulk' ? 'border-b-2 border-yellow-600 text-yellow-700' : 'text-gray-500'" 
        class="pb-2 font-medium">
        Bulk Import
      </button>
      <button 
        @click="tab = 'auto'" 
        :class="tab === 'auto' ? 'border-b-2 border-yellow-600 text-yellow-700' : 'text-gray-500'" 
        class="pb-2 font-medium">
        Auto-Connect
      </button>
    </div>
        ...
        <form class="space-y-6" onsubmit="return saveManual(event);">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="email" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" placeholder="Enter Email">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" placeholder="Eg: Horoscope, Numerology">
                </div>
                <div>
            ...
            <div>
                ...
                <textarea class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400" rows="4" placeholder="Enter any remarks or client requirements..."></textarea>
            </div>
    ...
    <div x-show="tab === 'auto'" class="bg-white rounded-xl shadow p-6">
      <form class="space-y-4" onsubmit="return saveAuto(event);">
         <div>
            ...
            <input type="text" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400">
        </div>

        <div>
            <label class="block text-sm font-medium text-gray-700">Integration Type</label>
            <select class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400">
        ...
        <button type="submit" class="px-4 py-2 bg-yellow-500 text-white rounded-lg shadow hover:bg-yellow-600">Save Integration</button>
    </form>
    </div>
