        ...
        <div id="lead1" draggable="true" ondragstart="drag(event)" class="bg-white rounded shadow-md cursor-move hover:shadow-lg">
          ...
          <div class="p-3 space-y-2">
            ...
            <div class="flex flex-wrap gap-2 mt-3">
              ...
              <button onclick="openConfirm()" class="flex items-center gap-1 bg-yellow-400 text-white text-xs px-2 py-1 rounded hover:bg-yellow-500">
                <!-- Calendar -->
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div id="lead5-lost" data-color="border-red-500" draggable="true" ondragstart="drag(event)"
          ...
          <div class="p-3 space-y-2">
            ...
            <div class="flex flex-wrap gap-2 mt-3">
              ...
              <button onclick="openConfirm()" class="flex item-center gap-1 bg-yellow-400 text-white text-xs px-2 py-1 rounded hover:bg-yellow-500">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                </svg>
...
<div id="confirmPopup" class="hidden fixed inset-0 flex items-center justify-center bg-black/30 bg-opacity-50 z-50">
  ...
  <path d="M6.225 4.811a1 1 0 011.414 0L12 9.172l4.361-4.361a1 1 0 111.414 1.414L13.414 10.5l4.361 4.361a1 1 0 01-1.414 1.414L12 11.914l-4.361 4.361a1 1 0 01-1.414-1.414L10.586 10.5 6.225 6.139a1 1 0 010-1.328z" />
      ...
      <button onclick="openForm()" class="px-4 py-2 bg-orange-600 hover:bg-orange-800 text-white rounded">Okay</button>
    </div>
  </div>
</div>
...
<div id="formPopup" class="hidden fixed inset-0 flex items-center justify-center bg-black/30 bg-opacity-50 z-50">
  ...
  <path d="M6.225 4.811a1 1 0 011.414 0L12 9.172l4.361-4.361a1 1 0 111.414 1.414L13.414 10.5l4.361 4.361a1 1 0 01-1.414 1.414L12 11.914l-4.361 4.361a1 1 0 01-1.414-1.414L10.586 10.5 6.225 6.139a1 1 0 010-1.328z" />
        ...
        <button type="submit" class="px-4 py-2 bg-orange-600 hover:bg-orange-800 text-white rounded">Save</button>
      </div>
    </form>
  </div>
</div>
