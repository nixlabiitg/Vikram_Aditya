...
<div class="main-content p-6">
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-4 md:mb-6 space-y-2 md:space-y-0">
        <h1 class="text-2xl font-bold text-[#7A3E00]">Register Family Member</h1>
        <p><strong>Name:</strong> Rajesh, <strong>Phone no. :</strong> 9876543210, <strong>ID :</strong> VGJUN250006</p>
    </div>

    <div class="bg-[#FFF9F0] shadow rounded-lg p-6 border border-[#FFD699]">
        <form id="clientForm" class="space-y-6" onsubmit="return saveClient(event);">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-1">Relation</label>
                    <select class="w-full border border-gray-300 rounded px-4 py-2 text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400">
                ...
                <div>
                    ...
                    <input type="date" class="w-full border border-gray-300 rounded px-4 py-2 mb-4 text-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-300 focus:border-orange-400">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-1">Date of birth</label>
                    <input type="date" class="w-full border border-gray-300 rounded px-4 py-2 mb-4 text-gray-400">
                </div>
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-1">Place of birth</label>
                    <input type="date" class="w-full border border-gray-300 rounded px-4 py-2 mb-4 text-gray-400">
                </div>
                <div>
                    <label class="block text-[#7A3E00] font-semibold mb-1">Time of birth</label>
                    <input type="time" class="w-full border border-gray-300 rounded px-4 py-2 mb-4 text-gray-400">
                </div>
            </div>
            ...
            <div>
                <button type="submit" class="px-4 py-2 bg-[#FF7F50] text-white rounded hover:bg-[#E67300]">Save Member</button>
            </div>
        </form>
    </div>
</div>
