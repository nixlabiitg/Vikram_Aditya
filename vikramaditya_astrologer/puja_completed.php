...
const acceptedOrders = [
  ...
  },
  {
    ...
    items:[
      {name:"Ganesh Puja", price:"₹10,000"},
      {name:"Narayan Puja", price:"₹5,000"}
    ],
...
function viewItems(orderIndex) {
  ...
  order.items.forEach((item, idx) => {
    modalItems.innerHTML += `
      <li class="flex justify-between items-center border-b borde-gray-300 pb-2">
        <span>${item.name}</span>
