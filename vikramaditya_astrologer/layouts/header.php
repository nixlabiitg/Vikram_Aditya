...
<html>
  ...
  <body x-data="{ sidebarOpen: false, sidebarCollapsed: false }">
    <div
     ...
     style="--select-button-svg: url('data:image/svg+xml;...'); font-family: Inter; background: linear-gradient(180deg, #ee7245ff, #fff9ec);">
      <div class="layout-container flex h-full grow flex-col w-full min-w-0">
        ...
        <header 
          ...
          :class="sidebarCollapsed 
            ...
            <div>
              <h1 class="text-white text-2xl font-bold">Astrologer</h1>
            </div>
