        ...
        <form id="clientForm" class="space-y-6" onsubmit="return saveClient(event);">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select class="w-full border border-gray-300 rounded px-4 py-2 text-gray-400">
                ...
                <div>
                    ...
                    <input type="text" class="w-full border border-gray-300 rounded px-4 py-2" placeholder="Speak with Vikramaditya Or buy an Astro Product">
                </div>
                <div>
